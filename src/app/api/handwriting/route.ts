...
1. First, try to TRANSCRIBE the handwriting into plain English text. If unreadable, write "UNREADABLE".
2. Then ANALYZE the handwriting features:
   - Letter spacing
   - Shape distortion
   - Line alignment
   ...
   - Risk indicators of dysgraphia or related issues

3. Finally, return JSON ONLY in this format:
{
